        ...
        try:
            ...
            for i in range(0, total_dados, 2):
                ...
                for dado in lote:
                    ...
                    if img1 and img2:
                        try:
                            p_foto.add_run().add_picture(img1, width=largura_foto)
                        except Exception:
                        ...
                        try:
                            p_foto2.add_run().add_picture(img2, width=largura_foto)
                        except Exception:
                        ...
                        try:
                            p_foto.add_run().add_picture(img_unica, width=largura_foto)
                        except Exception:
